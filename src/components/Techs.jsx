...
export const Techs = () => {
  return (
    <section className="h-screen bg-[#0a182e] flex flex-col justify-center items-center">
      <Slide bottom>
        <div className="w-4/6">
          <div className="text-gray-300 flex flex-col md:block items-center text-4xl md:text-7xl text-left font-bold font-Roboto mt-20 bg-[#0a182e] drop-shadow-2xl p-10 rounded-2xl">
          ...
          <div className="bg-[#0a182e] md:drop-shadow-2xl md:p-10 md:rounded-2xl mt-8">
            <p className="mt-8 font-Roboto text-greenLight text-left text-xl">
              ...
              programación y tecnologías. De todas maneras, aquí dejo unos
              cuantos con los cuales trabajo más a menudo:
            </p>
